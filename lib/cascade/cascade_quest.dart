...
import 'package:tatneft_quest/cascade/cs_first.dart';
import 'package:tatneft_quest/main_p.dart';
import 'package:tatneft_quest/shamsinur/sh_first.dart';

class CascadeQuest extends StatefulWidget {

  @override
  _CascadeQuestState createState() => _CascadeQuestState();
}

class _CascadeQuestState extends State<CascadeQuest> {
  @override
        ...
        children: <Widget>[
          Center(
            child: Padding(
                ...
                child: Text("Каскад прудов",style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),)),
          ),
