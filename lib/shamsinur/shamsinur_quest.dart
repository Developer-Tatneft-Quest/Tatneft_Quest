...
class ShamsinurQuest extends StatefulWidget {

  @override
  _ShamsinurQuestState createState() => _ShamsinurQuestState();
}

class _ShamsinurQuestState extends State<ShamsinurQuest> {
  @override
        ...
        children: <Widget>[
          Center(
            child: Padding(
                ...
                child: Text("Парк Шамсинур",style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),)),
          ),
