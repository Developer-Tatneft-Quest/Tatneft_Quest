...
class CascadeQuestWidget extends StatefulWidget {
  @override
  _CascadeQuestWidgetState createState() => _CascadeQuestWidgetState();
}

class _CascadeQuestWidgetState extends State<CascadeQuestWidget> {
  @override
        ...
        children: <Widget>[
          ...
          Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, MainNavigationRouteNames.cascadeFirstPointScreen);
                },
                child: Padding(
