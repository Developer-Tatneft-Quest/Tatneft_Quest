...
class CityThirdPointWidget extends StatefulWidget {
  @override
  _CityThirdPointWidgetState createState() => _CityThirdPointWidgetState();
}

class _CityThirdPointWidgetState extends State<CityThirdPointWidget> {
  bool change1 = false;
          ...
          Padding(
              ...
              child: ElevatedButton(
                ...
                child: Container(
                  ...
                  child: Text("Лучший парк республики"),
                ),
              )),
          Padding(
              padding: EdgeInsets.symmetric(vertical: 3, horizontal: 0),
