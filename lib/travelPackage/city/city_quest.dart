...
class CityQuestWidget extends StatefulWidget {

  @override
  _CityQuestWidgetState createState() => _CityQuestWidgetState();
}

class _CityQuestWidgetState extends State<CityQuestWidget> {
  @override
        ...
        children: <Widget>[
          ...
          Padding(
              ...
              child:ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushReplacementNamed(context, MainNavigationRouteNames.cityFirstPointScreen);},
                child: Padding(
