...
class ShamsinurSecondPointWidget extends StatefulWidget {
  @override
  _ShamsinurSecondPointWidgetState createState() =>
      _ShamsinurSecondPointWidgetState();
}

class _ShamsinurSecondPointWidgetState
    extends State<ShamsinurSecondPointWidget> {
  bool change1 = false;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Text("Точка №1"),
          Text("Вопрос 2/3"),
          Text("Сколько выделяют \"групп мышц\" в парке Шамсинур?"),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushReplacementNamed(context,
                      MainNavigationRouteNames.shamsinurThirdPointScreen);
                },
                child: Padding(
